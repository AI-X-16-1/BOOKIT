...
Next.js (App Router, TypeScript) · Supabase PostgreSQL + Auth (Google only) · Vercel Route Handlers (no Edge Functions) · one LLM vendor, server-side only · Vercel · no Storage.
