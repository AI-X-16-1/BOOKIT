...
-- cover_url 은 여기선 비워두고 §1-g 에서 생성한 표지(public/covers)로 채운다. 검색 유입 책은 알라딘 image URL (CLAUDE.md §10).
...
-- ── 1-e. 장르 빈칸 메우기 (2026-09-17) ─────────────────
-- 서재 44권이 동화·고전에 쏠려 장르 도장판 15칸 중 9칸이 비어 있었다.
-- 추리(동생을 찾으러)와 예술(어린 음악가)을 채운다. 역사·SF·과학은 저작권 만료
-- 공개저작물로 채울 만한 것이 없다 — 신채호의 역사물은 문체가 중학생에게도 어렵다.
insert into books (id, isbn13, title, author, publisher, tags,
                   target_grade_min, target_grade_max, is_public_domain,
                   library_url, aladin_url, curated) values
  ('0000b132-0000-4000-8000-000000000132', null, '미련이 나라', '방정환', null, '{"동화","고전"}', 2, 4, true, null, null, true),
  ('0000b133-0000-4000-8000-000000000133', null, '어린 음악가', '방정환', null, '{"동화","예술"}', 3, 5, true, null, null, true),
  ('0000b134-0000-4000-8000-000000000134', null, '동생을 찾으러', '방정환', null, '{"추리","모험"}', 5, 7, true, null, null, true)
on conflict (id) do update set
  title = excluded.title, author = excluded.author, tags = excluded.tags,
  target_grade_min = excluded.target_grade_min, target_grade_max = excluded.target_grade_max,
  is_public_domain = excluded.is_public_domain, curated = excluded.curated;
...
insert into book_contents (book_id, chapter_no, title, body) values
  ('0000b132-0000-4000-8000-000000000132', 1, '1장',
...
어른들이 새 옷을 꺼내 입고, 길이 막히게 꾸역꾸역 모여들었습니다. 새 발명을 했다는 연구가가, 헛간에 큰 절구 있는 곳에 서서, 큰 소리로 연설하는 말씀이,'),
  ('0000b132-0000-4000-8000-000000000132', 2, '2장',
...
(《어린이》 1926년 12월호의 부록 《어린이세상》 13호)'),
  ('0000b133-0000-4000-8000-000000000133', 1, '1장',
   '소녀 에르지가 열한 살 되는 해 생일날 밤이었습니다. 밖에는 캄캄한 밤인데 비가 주룩주룩 오고 있었습니다. 에르지는 아버지 크레븐 박사와 둘이서 생일의 축하 음식을 먹으면서 즐겁게 이런 이야기 저런 이야기 하다가 언뜻 생각이 난듯이,
...
“그 애가 바이올린을 잊어버리고 갔나?”'),
  ('0000b133-0000-4000-8000-000000000133', 2, '2장',
   '“아니요, 잊어버리고 간 것이 아녜요.”
...
박사와 에르지 색시와 루이가 5년 만에 이 방에 모여 즐겁게 이야기하고 있는 그 창 밖에는 오늘도 비가 주룩주룩 오고 있었습니다.'),
  ('0000b134-0000-4000-8000-000000000134', 1, '1장',
...
되도록 조사는 해 보지마는 처음에 붙잡힌 집이 정동 기와집이라 하니, 그런 집이 하나둘뿐이 아니고, 지금 잡혀 가 있다는 집은 동네부터 알 수 없으니, 이 넓은 장안에 어느 구석에 붙잡혀 있는지 알 수가 있느냐는 말이었습니다.'),
  ('0000b134-0000-4000-8000-000000000134', 2, '2장',
...
그러니, 그러게 무섭고 고요한 속에서도 이따금 이따금 들려오는 것은 어린 소녀의 신음하는 소리였습니다. 무서운 병든 이의 앓는 소리같이 끙끙 앓는 소리였습니다. 그 불쌍한 소리가 이따금 들려 와서 담 위에 엎드려 있는 창호의 귀에 들릴 때 창호는 온몸에 소름이 쪽쪽 끼쳤습니다.'),
  ('0000b134-0000-4000-8000-000000000134', 3, '3장',
...
하였습니다.'),
  ('0000b134-0000-4000-8000-000000000134', 4, '4장',
   '《어린이》 3권 4호 (1925년 4월호).
...
“아직 새벽이어서 아무도 없으니까 지금은 어떻게 처리할 수가 없고 있다가 여덟 시가 되어야 주임과 여러분이 오실 터이니까 그 때에 오너라!”'),
  ('0000b134-0000-4000-8000-000000000134', 5, '5장',
...
경성을 떠나 중국 봉천을 향하는 급행차로는 저녁 7시 20분에 특별 급행차가 있고, 10시 50분에 떠나는 보통 급행차가 있습니다.'),
  ('0000b134-0000-4000-8000-000000000134', 6, '6장',
...
하였습니다.'),
  ('0000b134-0000-4000-8000-000000000134', 7, '7장',
...
“덤벼라!”'),
  ('0000b134-0000-4000-8000-000000000134', 8, '8장',
...
무섭고 겁나는 중에도 오래간만에 순희를 보는 창호의 눈에는 눈물이 글썽하였습니다.'),
  ('0000b134-0000-4000-8000-000000000134', 9, '9장',
...
-- ── 1-f. 초1~3 대상 방정환 동화 9편 (2026-09-18) ─────
-- 타겟을 초1~3 으로 좁히면서 그 구간 책이 얇았다. 위키문헌 방정환 작품 69편을
-- 옛 표기·한자 비율·본문 유무로 거른 뒤, 남은 것을 한 편씩 읽어 골랐다.
-- 뺀 것: 수필(어린이 찬미 등 서사가 없다), 하메른의 쥐난리(아이들이 사라지는 결말에
-- 장애 비하 표현이 붙어 있다), 삼손 이야기(종교·폭력), 느티나무 신세 이야기(육담),
-- 천일야화(이야기가 아니라 소개글), 제일 짧은 동화(말놀이 모음이라 빈틈을 물을 수 없다).
insert into books (id, isbn13, title, author, publisher, tags,
                   target_grade_min, target_grade_max, is_public_domain,
                   library_url, aladin_url, curated) values
  ('0000b135-0000-4000-8000-000000000135', null, '참된 동정', '방정환', null, '{"동화","사회"}', 1, 3, true, null, null, true),
  ('0000b136-0000-4000-8000-000000000136', null, '엉터리 병정', '방정환', null, '{"동화","고전"}', 1, 3, true, null, null, true),
  ('0000b137-0000-4000-8000-000000000137', null, '과거 문제', '방정환', null, '{"동화","고전"}', 2, 4, true, null, null, true),
  ('0000b138-0000-4000-8000-000000000138', null, '영길이의 설움', '방정환', null, '{"동화","가족"}', 2, 4, true, null, null, true),
  ('0000b139-0000-4000-8000-000000000139', null, '뿌움뿌움 이야기', '방정환', null, '{"동화","우정"}', 2, 4, true, null, null, true),
  ('0000b140-0000-4000-8000-000000000140', null, '절영도 섬 너머', '방정환', null, '{"동화","가족"}', 3, 5, true, null, null, true),
  ('0000b141-0000-4000-8000-000000000141', null, '방귀 출신 최덜렁', '방정환', null, '{"동화","고전"}', 3, 5, true, null, null, true),
  ('0000b142-0000-4000-8000-000000000142', null, '막보의 큰 장사', '방정환', null, '{"동화","모험"}', 3, 5, true, null, null, true),
  ('0000b143-0000-4000-8000-000000000143', null, '금시계', '방정환', null, '{"성장소설","가족"}', 4, 6, true, null, null, true)
on conflict (id) do update set
  title = excluded.title, author = excluded.author, tags = excluded.tags,
  target_grade_min = excluded.target_grade_min, target_grade_max = excluded.target_grade_max,
  is_public_domain = excluded.is_public_domain, curated = excluded.curated;
...
insert into book_contents (book_id, chapter_no, title, body) values
  ('0000b135-0000-4000-8000-000000000135', 1, '1장',
   '어느 해 몹시 추운 겨울날이었습니다.
...
그리고, 고개를 푹 숙인 어린 거지의 때묻은 얼굴에는 알지 못할 감격의 눈물이 방울방울 흘렀습니다.'),
  ('0000b136-0000-4000-8000-000000000136', 1, '1장',
...
하면서 황제가 벌떡 일어났습니다. 그러니까 이 미련한 양반은 시험을 다 보고 황제가 저를 칭찬하는 줄 알고 허리를 자꾸 굽실거렸습니다.'),
  ('0000b137-0000-4000-8000-000000000137', 1, '1장',
...
그 후, 그 사람이 대신이 되었을 때, 대신의 부인은 머리가 없다는 소문이 돌았으나, 나라를 잘 다스리고, 부인은 시아버지를 잘 봉양하여 늙도록 잘 살았습니다.'),
  ('0000b138-0000-4000-8000-000000000138', 1, '1장',
   '봄이 왔습니다……. 외로운 사람의 가슴을 더울 쓸쓸하게 하는 봄이…….
...
날이 저물기 시작하였습니다.'),
  ('0000b139-0000-4000-8000-000000000139', 1, '1장',
...
하고, 손을 쥐어 정답게 흔들었습니다. 그리고, 다시 한 번 프랑수아의 뺨에 입을 맞추고 돌아가 버렸습니다.'),
  ('0000b140-0000-4000-8000-000000000140', 1, '1장',
   '가을! 나뭇잎 떨어지는 가을……. 공연히 마음이 쓸쓸해지는 가을날 저녁 때……, 상천이는 울고 싶은 가슴을 억지로 참으면서 오늘도 언덕 위 풀밭에 앉아서 쓸쓸히 바다만 보고 있습니다.

부산 바다 물 건너 저물어가는 절영도 섬에는 저녁밥 짓는 연기가 보랏빛으로 피어오르고 배도 없는 바다에는 햇빛만 붉게 비치는데 하얀 물새들이 청승스럽게 날개를 저으면서 날아다니고 있습니다.

한 마리, 두 마리, 세 마리, 네 마리……. 아아 저 새들은 그래도 형이며 아우가 갖추어 있는가보다……, 생각을 할 때 어린 상천이는 가슴이 터질 것 같은 슬픈 생각이 더하였습니다.

상천이는 아버지 어머니 얼굴도 모르고 자랐습니다. 몇 살 때에 어머니 아버지가 돌아가셨는지 그것도 알지 못하고 어리고 외로운 몸이 오직 단 한 사람뿐인 언니하고 단 둘이 외삼촌 댁에 붙어 있으면서 쓸쓸스럽게 자란 몸이었습니다.

상천이가 어머니 아버지의 생각이 나기 시작하기는 일곱 살 되던 해 가을부터였습니다. 그 때에 언니는 열두 살이었는데 언니는 아버지 어머니의 얼굴을 알기나 하는지……. 상천이는 얼굴을 몰라서 생각이나 해 보려도 머리에 잘 나타나지 않았습니다. 그것이 더욱 서러워서 밥마다 아침마다 남모르게 눈물을 지었습니다.

외삼촌 댁에는 상천이와 나이가 어상반한 외삼촌의 아들과 딸이 있어서 늘 상천이를 업신여기고 심부름만 시키곤 하였습니다. 일곱 살이 되기까지는 철 모르는 마음에 맞붙어 싸우기도 하였지만 그 후부터는 아무 일을 시켜도 잠자코 하였고 아무 욕을 하여도 혼자 돌아서서 울기만 할 뿐이었습니다. 그러나 그럴 때마다 어머니 아버지 없는 설움이 어린 뼈에 사무쳤습니다. 그럴 때마다 어린 상천이는 언니의 손목에 매어달려서 어떻게 어떻게 슬프게 울었는지 모릅니다.

“상천아, 울지 마라. 아주머니에게 들키면 또 야단맞는다…….우리가 복이 없어서 그런데 어떻게 하니. 이 다음에 어머니 산소에 가거든 거기서나 실컨 울자…….”

언니의 말 소리도 울음에 떨리면서 상천이의 숙인 머리 위에 언니의 눈물이 방울방울 떨어졌습니다.

불도 켜지 아니한 어두운 방에서 어린 형제가 애처롭게 울면서 사는 생활도 한 해 두 해 쓸쓸히 지나갔습니다.

상천이가 열한 살 되는 해 이른 봄에 불행히 외삼촌이 병환으로 돌아가신 후로는 그 집의 살림이 곤란하여졌고 상천이의 형제를 불쌍하게 여겨 줄 사람도 없어졌습니다. 살림이 어려워져서 너의 형제를 전처럼 먹이고 입혀 줄 수 없으니 아무 데로라도 먹을 곳을 찾아가거라고 성화같이 박대하는 아주머니 말씀에 어린 두 형제는 또 얼마나 가슴을 태우며 울었겠습니까.

세상은 넓다 하지만 가는 곳마다 청산은 있다 하지만 의지가지없는 외로운 몸이 외가에서 쫓겨나면 단 한 걸음을 내어디딜 곳이 어디 있겠습니까.

견디다 견디다 못하여 그 봄에 언니는 상천이를 남겨 놓고 열여섯 살의 어린 몸으로 배를 타고 일본으로 건너가서 아무런 고생이라도 하여 돈을 벌어 보낼 터이니 상천이 하나만 길러 달라고 애걸애걸하며 맡겨 놓고 외로운 먼 길을 떠나갔습니다.

절영도 저 너머 바다를 건너가는 몸이 이불 하나 옷 하나 가진 것이 없이 맨주먹 맨몸으로 부두에서 배를 탈 때 아! 춥고 외롭고 슬퍼서 그는 소리쳐 울고 싶었습니다.

그러나 그러나 그것보다도 어머니 아버지의 얼굴도 모르고 형 하나만 부모같이 믿고 있던 어린 상천이를 반가워하지 않는 외갓집에 외롭게 남겨 두고 가는 생각을 할 때 그는 눈이 캄캄하였습니다.

‘언니 ─ 나는……’

하면서 무슨 말인지 하려다 못하고 매달려 우는 상천의 손목을 잡을 때 언니의 몸은 소름이 쪽 끼치고 추위에 떨렸습니다.

‘오오, 죽거나 살거나 같이 가자!’

몇 번이나 이렇게 부르짖고 싶었으나 그것도 안 될 일이고……. 그는 이를 악물고 흑흑 느껴 울었습니다.

‘부우 ─’하고 기적 소리가 처량스럽게 들리더니 배는 차츰 차츰 부산항구, 조선 땅을 떠나기 시작하였습니다.

‘언니 ─ 언니.’

외롭게 외롭게 혼자 떨어지는 상천이가 마지막으로 우는 소리로 부르면서 쫓아올 것처럼 날뛰는 것을 보고 언니는 그만 뱃머리에 퍼덕 쓰러져 엉엉 울었습니다. 애끊는 울음을 싣고 커다란 기선은 검은 연기만 남겨 놓고 절영도 섬을 휘 돌아 일본으로 달아났습니다.

그 후 혼자 남아서 상천이가 어떻게 미움을 받으면서 구박 받는 살림을 하고 있는지 그것도 너무도 슬픈 일이어서 말씀도 못하겠습니다.

그러나 큰일 난 일이 있었습니다 . 일본으로 건너간 언니는 동경에 가서 자전거 만드는 회사에 가서 심부름을 하고 있다고 한 달에 편지 한 장과 돈 5원씩을 꼭꼭 붙여 보내더니 웬일인지 그 해 가을부터 편지가 뚝 그친 후로 한 달 두 달 아무 소식이 없어져 버렸습니다. 지진이 나서 사람이 많이 죽었으니까 아마 상천이 언니도 필경 죽은 것이라고 동네 어른들이 하는 소리를 듣고 상천이는 미칠 듯이 울면서 날뛰었으나 아무리 알아보아도 아는 수가 없이 그냥그냥 소식이 없어지고 말았습니다.

편지마다 편지마다 상천이 생각을 하고 운다 하던 언니가 살아 있고는 편지를 아니할 리가 없는데 싶어서 어린 상천이는 그 때부터 넋을 잃고 밥도 잘 안 먹고 미친 사람같이 눈물만 흘리면서 바닷가에 나가서는 언니가 떠나가던 절영도 저 너머를 우두커니 바라보고만 있었습니다.  혹시나 혹시나 꿈결같이 언니가 배를 타고 절영도 저편으로 돌아오지나 않는가 하고…….

그러나 슬픈 일로는 몇 달이 지나도 아무 소식이 없었습니다. 밤이면 외로운 자리에 혼자 누워서 울기만 하다가 날이 밝으면 바닷가에 나와서 절영도 너머를 바라보기만 하는 생활이 한 달 또 두 달 겨울이 지나가고 봄철이 되도록……, 그 봄이 지나가고 또 가을이 오도록 금년까지 벌써 삼 년째 가을이 또 왔건마는 언니의 소식은 도무지 없었습니다.

오늘도 가을날이 저물기 시작하였건마는 언니마저 잃어버린 외로운 상천이가 파랗게 마른 얼굴에 눈물을 흘리면서 절영도 섬 너머 저물어가는 바다를 바라보고 있습니다.

부모도 친척도 없는 몸이 언니마저 돌아오지 아니하면 누구와 울고 누구를 믿고 살겠습니까……. 외롭게 외롭게 울면서 삼 년째 바다만 바라보고 살아온 슬픈 신세를 생각하면 상천이는 그냥 언니 언니 소리치면서 울고만 싶었습니다.

내일이 팔월 보름 추석날입니다. 남들은 형제가 손목잡고 부모님 산소에 가는 날입니다.  아아, 어머님 산소에 가거든 같이 놀자 하던 언니는 왜 아니 돌아옵니까. 저물어가는 바다는 말이 없이 잠잠할 뿐인데 상천이의 마음은 있는 대로 녹아 나오는 것처럼 하염없이 눈물이 샘솟듯 흘릴 뿐이었습니다.

상천이는 한숨을 쉬면서 기운없이 일어났습니다. 그러나 집으로 돌아갈 생각은 나지 않았습니다.

‘언니 ─ 언니.’

바다를 바라보면서 허청대고 슬픈 소리로 불러 보았으나 바다에서는 바람 소리밖에 아무 소리도 들리지 않았습니다.'),
  ('0000b141-0000-4000-8000-000000000141', 1, '1장',
...
고 하더랍니다.'),
  ('0000b142-0000-4000-8000-000000000142', 1, '1장',
   '어수룩하고, 사람 좋고, 어리석어 터진 사나이가 있었습니다.

이름도 우습게 막보라 하였습니다.

어느 날 암소를 장에 끌고 가서, 십 원에 팔아 가지고 돌아오는데, 연못 속에서 개구리들이 ‘개울 개울, 개울’ 하고 자꾸 울었습니다. 막보는 그 소리를 ‘구 원, 구 원’ 하는 소리로 듣고, 혼자 투덜투덜하였습니다.

“저놈들이 알지도 못하고, 저런 소리를 하네. 내가 얼마에 팔았는지 알지도 못하면서, 가장 아는 체하고, ‘구 원 구 원’이 무어야. 이놈들아, 구 원이 아니라 십 원이란다, 십 원이야…….”

하면서, 연못 옆에까지 가까이 오니까, 또 물 속에서, ‘개울 개울 개울’ 하였습니다.

막보는 화를 내면서,

“저 못난 놈들이 그대로 구 원이라네. 이놈들아, 구 원밖에 모르니? 십 원이란다, 십 원…….”

하고, 소리를 질렀습니다. 그래도 개구리들은 ‘개울 개울 개울’하고 울었습니다. 막보는 그만 골이 나서,

“오냐! 그렇게 거짓말인 줄 알면 세어 보여 주마. 너희 보는 데서 세어 보마.”

하고, 털석 주저앉아서, 암소 판 돈 십 원을 꺼내 들고,   ‘일 원, 이 원’ 하고 세어 보였습니다. 그러나 그대로 개구리들은 물 속에서 ‘개울 개울 개울’ 하고 울었습니다.

‘에잇’ 하고, 막보는 모자를 벗어 던지고 벌떡 일어나서, 악을 쓰면서,

“이놈들아, 그래도 못 믿거든 너희 손으로 세어 보려므나. 십 원이 아닌가…….”

하고, ‘일 원! 이 원! 삼 원!’ 하고 하나씩 하나씩 연못 물 속에 퐁당퐁당 넣어 버렸습니다.

물 속에서는 여전히 ‘개울 개울’ 하고 울 뿐이었습니다.

“암만 구 원 구 원 하고 헤어 보려므나. 십 원이 못 되는가?”

하고, 막보는 다시 털썩 주저앉아서 개구리들이 돈을 다 헤이고 도로 내다 주기를 기다리고 있었습니다.

그러나, 아무리 오래 기다리고 앉았어도 개구리들은 ‘개울 개울’ 하고 울기만 할 뿐이고, 돈을 다시 내다 주지 않습니다. 얼마나 오래 기다렸는지 벌써 해가 지고, 허리가 아파서 못 견디게 되어서, 사람 좋은 막보는 그만 골이 벌컥 나서 욕을 퍼붓기 시작하였습니다.

“이 연못지기! 깡충깡충이! 콩알 눈의 올챙이새끼! 이놈들아, 너희놈들이 암만 그렇게 메기 주둥이를 벌리고 떠들고, 남을 놀려도, 그까짓 돈 십 원도 못 헤이는 못난이가 왜 구 원 구 원 하고, 나를 놀리느냐 말야……. 너희들이 돈 십 원을 못 헤이고, 암만 ‘구 원 구 원’ 하면, 내가 밤중까지라도 기다리고 있을 듯 싶으냐?”

하고, 벌떡 일어나서, 아주 시원스럽게 휘적휘적 가 버렸습니다. 그래도 개구리들은 뒤에서 ‘개울 개울 개울’ 하고 소리들을 지르므로, 막보는 골이 머리 끝까지 올라서, 제 주먹으로 제 머리를 탕탕 때리면서 돌아갔습니다.

사흘이 지난 후에 막보는 소를 한 마리 샀습니다. 이번에는 그 소를 잡아서 고기를 팔 작정이었습니다.

예산대로 잘 팔리면, 고기만 팔아도 소를 두 마리를 살 만한 돈이 생기고, 그 외에 쇠껍질은 그저 남게 되는 판이었습니다.

그래, 막보가 쇠고기를 짊어지고 장터로 가노라니까, 그 동네 개들이 수없이 많이 따라나와서, 고기 냄새를 맡느라고 야단이고, 그 중에도 제일 큰 사냥개가 앞장서서 고기 주머니를 물어 뜯으려고, ‘멍 멍 멍’ 하고 짖으면서 기승을 피었습니다.

암만 쫓아도 가지 않고 애걸애걸하는 것을 보고, 어수룩한 막보는 사냥개를 보고,

“웅, 알아들었다. 네가 이 고기를 자꾸 달라고 조르지만, 이 고기는 돈을 안 받고는 줄 수가 없단다.”

그래도, 개는 또 ‘멍 멍 멍’ 하고 짖었습니다.

“오오, 그럼 저렇게 많은 네 동무들이 먹을 고기 값도 네가 내겠단 말이지.”

하고, 막보는 개를 보고 뒤를 다졌습니다. ‘멍 멍 멍’ 하고 또 짖었습니다.

“오오, 네가 그렇게까지 말하니, 내 고기를 팔마……. 나는 너를 잘 알 뿐 아니라, 너희 집 주인까지 잘 알고 있는 터이니까, 특별히 외상으로 파는 것이다. 그러나 꼭 사흘 안으로 가져와야 한다. 안 가져 오면, 내가 야단을 칠 테니까……. 꼭 사흘 안으로 집으로 가져 오너라.”

막보는 이렇게 단단히 일러 놓고는, 아주 마음놓고, 고기를 거기다 모두 풀어헤쳐 놓고, 시원스런 걸음으로 돌아갔습니다. 개들은 ‘이게 웬 떡이냐’ 하고, 와르르 달려들어 기운껏 양껏 뜯어먹었습니다. 막보는 멀리서 그것을 돌아다보고,

“단단히 믿는다. 여럿이 모두 덤벼 먹더라도, 고기값일랑은 그 중 큰 사냥개가 내야 한다.”
...
하고 좋아하면서, 기다리고 있었습니다. 그러나, 온종일 그 날 해가 지도록 허리가 아프게 앉아서 고대고대하여도, 아무도 돈을 가져오지 않았습니다. 막보는 그만 골이 나서 주먹을 휘저으면서,

“에이, 내가 인제 어느 놈이든지 신용을 하나 보아라.”

하고, 혼자 빙빙 돌아다녔습니다.

그 이튿날 막보는 날이 채 밝기도 전에 장터로 뛰어가서, 사냥개 임자의 집에 가서 문을 두드리고 자는 주인을 불러내어, 고기값을 내라 하였습니다. 사냥개 임자는 무슨 까닭을 몰라서, 어리둥절할 뿐이었으나, 막보는 천연스럽게,

“그렇게 시치미를 떼지 말고 돈을 내어요. 사흘 전에 당신 집 사냥개가, 사흘 안으로 돈을 꼭 가져온다 하고 소 한 마리 잡은 고기를 모두 먹었으니, 어서 그 고기값을 내어요.”

하고, 조르는 소리를 듣고, 그 임자는 그만 허리가 끊어지게 배를 안고 웃더니, 나중에는 미친 놈이라고 작대기로 두들겨 쫓아 버렸습니다.

막보는 분하기 짝이 없어서, 주먹을 휘두르면서 한참이나 떠들다가, 나중에는,

“안 내고 견디나 보아라. 내가 임금님께 재판을 걸어서라고 받고야 말 터이니.”

하고, 그 길로 대궐로 뛰어가서 호소를 하였습니다.

막보는 임금님 앞으로 불리어 갔습니다. 임금님은 꿇어 엎드린 막보를 내려다보시고, 여러 가지를 물으신 후에,

“그래 어떻게 속았단 말이냐?”

하고, 물으셨습니다. 막보는 시키지도 않는 절을 자꾸 하면서,

“예 예, 개구리라는 놈하고 개라는 놈이 제 밑천을 다 집어먹고, 개 임자라는 놈은 내라는 돈은 안 내고, 몽둥이만 냈답니다.”

하고, 처음부터 끝까지 자세 자세 여쭈었습니다.

그러니까, 그 때에 임금님 옆에 섰던 꽃같이 잘 생긴 왕녀님이 듣고 있다가, 별안간에 부끄럼도 모르고, 깔깔깔 소리를 지르고 웃었습니다.

그러자, 그것을 보시고 임금님도 따라 웃으시면서,

“오늘은 그 재판을 해 줄 수는 없으나, 그 대신 너는 오늘부터 내 사위가 되게 되었다. 이 아기는 날 적부터 이날 이때까지 한 번도 웃어 보지를 못해서, 누구든지 이 아기를 웃기는 사람이 있으면, 그 신랑을 삼아 내 사위를 삼겠노라고 약속을 했는데, 오늘까지 아무도 웃기는 사람이 없더니, 오늘 네가 처음 웃겼으니, 너는 참말 복 많은 사람이다.”

하셨습니다. 막보는 또 시키지도 않는 절을 자꾸 하면서,

“에그머니! 그것만은 제발 용서해 주십시오. 저희 집에도 마누라가 있는데, 마누라 하나도 잘 먹여 살리지 못해서, 주체를 못 하는데요. 마누라를 또 얻어요? 제발 그건 용서…….”
...
“에그머니, 제발 살려 주십시오. 죽여도 장가는 또 못 들겠습니다. 시골놈이 그저 그렇지요. 살려 주십시오.”
...
“그럼, 너에게는 그 대신 다른 상을 줄 것이니, 오늘은 그냥 돌아가고, 사흘 후에 다시 오너라. 그 때 오백 금상을 줄 것이니…….”
...
막보가 기쁨을 참지 못하여 좋아하면서, 대궐 문으로 나오노라니까, 문지기가 불러 가지고 이렇게 수작을 건네었습니다.

“자네는 왕녀님을 웃기었으니까, 상금을 많이 타겠네그려.”

“응, 당신 말씀같이 많이 타게 되었소. 오백 금을 주신답니다.”'),
  ('0000b142-0000-4000-8000-000000000142', 2, '2장',
   '“응 오백 금! 수가 났네그려. 그럼, 그 중에서 다만 얼마간이라도 나 좀 주게그려. 자네 혼자서는 그 돈을 주체를 못할 것이니까…….”

“응, 그러지. 그럼 당신에게 이백 금을 드릴 것이니, 사흘 지나거든 임금님께 그렇게 여쭙고, 받아 가지시오그려.”

선선하게 대답하고는 활활 가 버렸습니다.

그러니까, 아까부터 막보와 문지기와 두 사람의 이야기를 듣고 섰던 욕심쟁이 양반 한 사람이, 부리나케 쫓아와서, 막보의 소매를 붙잡고 이렇게 말했습니다.

“자네는 놀랍게 복이 많으이그려. 그렇게 큰 돈을 어떻게 쓰나? 내가 잔돈으로 바꿔 줌세. 어떤가? 좋지 않은가?”

“네, 그러시오. 바꾸고말고요. 그럼 삼백 금이 남았으니, 잔돈으로 삼백금을 주시오. 그리고 사흘 후에 임금님 앞에서 삼백 금 돈을 찾아가시오그려.”

엉큼한 욕심쟁이는 헌 돈(값 나가지 않는 싼 돈)을 주고 새 돈 삼백 금을 바꾸면 크게 이익이 되겠으니까, 그리한 것이었습니다. 그래 속으로 ‘옳다 되었다!’ 하고 좋아하면서, 헌 돈을 삼백 금 갖다 주었습니다. 실상은 백 금어치도 못 되는 것이건마는, 어수룩한 막보는 그것을 받아 가지고 활갯짓을 하면서, 커다란 걸음으로 갔습니다.

사흘이 지나서 막보는 약속대로 임금님께로 갔습니다. 임금님은 막보를 보시고 시종에게 명령하시되,

“이 무례한 놈을 웃옷을 벗기고, 금 채찍으로 오백 대만 때려 주어라.”

하셨습니다. 상금 오백 금을 주실 줄 알고 있던 막보는 깜짝 놀라, 또 절을 자꾸 하면서,

“아아니올시다. 그것은 벌써 제 차지가 아니올시다. 그 날 나갈 때에 그 중 이백 금은 문지기에게 주기로 하고, 또 나머지 삼백 금은 저기 들어오는 저 양반에게 주기로 하였으니까, 그것은 그 사람들의 차지올시다. 제 차지라고는 하나도 없답니다.”

하고 여쭈었습니다. 그 판에 문지기와 욕심쟁이 양반이 제각각 돈을 찾으려고 어슬렁어슬렁 들어왔습니다. 그러나 돈은커녕 그 수효만큼 채찍으로 얻어맞게만 되었습니다. 시종은 먼저 문지기를 붙들어 웃옷을 벗기고, 이백 대를 때리는데, 문지기는 그래도 잠자코 맞는데, 욕심쟁이 양반은 삼백 대를 맞는 동안, 울고불고 갖은 발광을 다 부리면서 얻어맞았습니다. 오백 대때리기가 끝난 후 임금님은 다시 막보를 부르셔서,

“너는 상을 타기도 전에 남에게 주는 착한 사람이니, 그 상으로 내 광에 가서 네 힘으로 가져갈 수 있을 만큼 돈을 꺼내 가거라.”

하셨습니다. 막보는 이게 웬 땡이냐 하고는 곧장 곳간으로 뛰어가서, 값 많은 금전을 호주머니에 가득 집어 넣어 가지고 나왔습니다.

욕심쟁이 양반은 매만 삼백 대를 죽도록 얻어맞은 것이 분하여서, 그 분풀이를 하려고, 막보의 뒤를 따라갔습니다. 막보는 뒤에서 누가 듣는 줄도 모르고, 가면서 혼자 중얼거렸습니다.

“그 능청스런 임금님이 사람을 잘 골리는걸……. 오늘도 자기 손으로 집어 주지 않고, 내 손으로 집어 가라고 한 것이 무슨 꿍꿍이 속인 줄 모르겠는걸……. 대관절 이놈의 돈이 가짜 돈이 아닌지 모르겠다.”

이렇게 하는 소리를 듣고 욕심쟁이 양반은,

“옳다, 되었다! 저 말을 임금님께 가서 여쭈면, 나는 상금을 타고, 저놈은 벌을 받을 것이다.”
...
하셨습니다. 욕심쟁이는 소원 성취나 한 것처럼 신이 나서, 급한 걸음으로 막보에게 가서,

“임금님이 오라 하시네. 또 무슨 수가 생기는 모양이니 얼른 가 보세.”

하였습니다. 그러니까, 막보는 태연하게,

“아니오. 인제는 나도 부자가 되었으니까, 임금님 앞에 가려면 좋은 예복을 입고 가야 합니다. 예복을 만들어 입고 가겠습니다. 나 같은 부자가 이렇게 찢어진 옷을 입고 가겠습니까”

하고, 일어나지도 아니하므로, 욕심쟁이는 한시바삐 이 놈이 벌을 받는 것을 보고 싶어서, 급급히 굴면서 가장 친절한 체하면서,

“그럼, 자네하고는 친한 터이니, 내가 입고 있는 이 새 웃옷을 빌려 줌세. 이것을 입고 어서 가세.”

하면서, 새로 만들어 입은 웃옷을 벗어서 막보에게 주었습니다.

막보는 좋아서 그 옷을 받아 입고, 아주 점잖은 걸음으로 욕심쟁이의 뒤를 따라 대궐로 들어갔습니다.

임금님은 막보를 보시더니, 얼굴을 찡그리시면서, 욕심쟁이에게 들은 말을 그대로 하시고, 큰 소리로,

“이놈아, 네가 무슨 일로 그런 욕을 하였단 말이냐? 말을 하여라! 목을 베일 터이다.”

하시는 것이, 당장에 큰 벼락이 내릴 것 같았습니다. 막보는 한참이나 머리를 긁으면서, 쩔쩔매다가 한참만에야,

“아니올시다. 제가 나쁜 말씀을 할 리가 있겠습니까? 저놈이 하는 말은 모두 거짓말이올시다. 저놈처럼 거짓말을 잘 하고 엉큼스런 놈은 없습니다. 저 놈은 아무나 보고, 남의 좋은 옷을 입은 것을 보면, 제 옷이라고 엉큼스런 거짓말을 하는 놈이올시다. 지금 이렇게 좋은 새 옷을 입었지요. 이것도 조금 있으면, 자기 옷이라고 떼를 쓸 엉큼한 놈입니다.”

하고, 욕심쟁이를 손가락으로 가리키며 여쭈었습니다. 그러니까, 욕심쟁이 양반이 하도 기가 막혀서 달려 들면서,

“무엇이 어째? 이놈아, 네가 지금 입고 있는 것이 내 옷이 아니고 무엇이냐. 남의 새 옷까지 떼어 먹으려고 그러느냐?”

하고, 야단을 쳤습니다. 그것을 보고 막보는 능청스럽게,

“그저 그렇지. 네 옷이라고 떼를 쓸 줄 알았다……. 자아! 이놈 좀 보십시오. 임금님 앞에서도 이렇게 남의 좋은 옷 입은 것을 보면, 제 옷이라고 거짓말을 하는 놈이올시다. 이놈의 말을 정말로 들으셨습니까”

“무엇이 어째? 이놈아! 네가 임금님 앞에 가려면 좋은 예복을 입고 가야 할 터인데, 입을 옷이 없다고 그래서 내가 빌려 준 게 아니고 무어냐?”

하고, 욕심쟁이는 악을 썼습니다. 임금께서는 거기까지 들으시더니, 오오 알았다! 하시는 듯이 욕심쟁이를 불러 세우시고, 이렇게 말씀하셨습니다.

“이놈아, 만일 네가 정말로 네 옷을 빌려 주었으면, 그렇게 옷까지 빌려 주는 친절한 사이면, 무슨 까닭으로 그 사람의 일을 나에게 일러서, 벌을 받게 하려고 하였느냐? 친절한 체하고 남을 해롭게 하는 것을 보면 네가 나를 속였든지 저 사람을 속였든지 어느 편이든지 속인 것이 분명하다. 네 이놈! 그 상으로 매를 오백 대만 맞고 나가거라.”

기어코 욕심쟁이는 붙들려서 울고불고 하면서, 매를 오백 대를 맞고, 막보는 새 옷에 금전을 많이 받고,

“인제는 정말 부자가 되었다.”

하면서, 활갯짓을 하면서, 집으로 돌아갔습니다.'),
  ('0000b143-0000-4000-8000-000000000143', 1, '1장',
...
‘오 옳지, 고놈이 제가 주인 방에 있으니까, 금시계를 훔쳐다가 잡히고 나중에 그 허물을 내게 둘러대노라고 오늘 또 금반지를 집어다가 내 책상에 넣어 논 것이 분명하구나. 그리고 지금 나를 부르러 왔다가 급히 뛰어가느라고 흘리고 갔구나‥‥‥. 오냐, 이것만 있으면 나는 도둑누명을 벗는다!’'),
  ('0000b143-0000-4000-8000-000000000143', 2, '2장',
...
‘아니다. 내가 그 애에게 말을 못 하였으면 주인에게라도 말을 해야 한다. 내가 쫓겨나더라도 그 애의 도적 누명을 벗겨 주어야 한다. 그 애는 나를 위하여 대신 쫓겨나기까지 하는데……. 아아! 내가 이렇게 잠자코 있단 말이냐…….’ 새벽녘에 이르러 이렇게 결심한 수득이는 아침 때가 되기를 기다렸습니다.'),
  ('0000b143-0000-4000-8000-000000000143', 3, '3장',
...
-- ── 1-g. 표지 일러스트 (2026-09-18) ─────────────────
-- 서재 56권 + 시드 15권은 알라딘 표지가 없어(저작권 만료·데모) 표지 퍼즐·도감·홈이 전부
-- 자리표시자였다. `npm run covers:generate` 로 한 번 생성해 public/covers/<id>.webp 로
-- 커밋했다 — 런타임 생성 파이프라인은 없다. 파일이 있는 책만 여기서 가리킨다.
-- 검색으로 들어온 책은 여전히 알라딘 image URL 을 쓴다 (CLAUDE.md §10).
update books set cover_url = '/covers/' || id::text || '.webp'
 where id in (
  '0000b001-0000-4000-8000-000000000001',
  '0000b002-0000-4000-8000-000000000002',
  '0000b003-0000-4000-8000-000000000003',
  '0000b004-0000-4000-8000-000000000004',
  '0000b005-0000-4000-8000-000000000005',
  '0000b006-0000-4000-8000-000000000006',
  '0000b007-0000-4000-8000-000000000007',
  ...
  '0000b016-0000-4000-8000-000000000016',
  '0000b017-0000-4000-8000-000000000017',
  '0000b018-0000-4000-8000-000000000018',
  '0000b019-0000-4000-8000-000000000019',
  '0000b020-0000-4000-8000-000000000020',
  '0000b021-0000-4000-8000-000000000021',
  '0000b022-0000-4000-8000-000000000022',
  '0000b023-0000-4000-8000-000000000023',
  '0000b024-0000-4000-8000-000000000024',
  '0000b025-0000-4000-8000-000000000025',
  '0000b101-0000-4000-8000-000000000101',
  '0000b102-0000-4000-8000-000000000102',
  '0000b103-0000-4000-8000-000000000103',
  '0000b104-0000-4000-8000-000000000104',
  '0000b105-0000-4000-8000-000000000105',
  '0000b106-0000-4000-8000-000000000106',
  '0000b107-0000-4000-8000-000000000107',
  '0000b108-0000-4000-8000-000000000108',
  '0000b109-0000-4000-8000-000000000109',
  '0000b110-0000-4000-8000-000000000110',
  '0000b111-0000-4000-8000-000000000111',
  '0000b113-0000-4000-8000-000000000113',
  '0000b114-0000-4000-8000-000000000114',
  '0000b115-0000-4000-8000-000000000115',
  '0000b116-0000-4000-8000-000000000116',
  '0000b117-0000-4000-8000-000000000117',
  '0000b118-0000-4000-8000-000000000118',
  '0000b119-0000-4000-8000-000000000119',
  '0000b120-0000-4000-8000-000000000120',
  '0000b121-0000-4000-8000-000000000121',
  '0000b122-0000-4000-8000-000000000122',
  '0000b123-0000-4000-8000-000000000123',
  '0000b124-0000-4000-8000-000000000124',
  '0000b125-0000-4000-8000-000000000125',
  '0000b126-0000-4000-8000-000000000126',
  '0000b127-0000-4000-8000-000000000127',
  '0000b128-0000-4000-8000-000000000128',
  '0000b129-0000-4000-8000-000000000129',
  '0000b130-0000-4000-8000-000000000130',
  '0000b131-0000-4000-8000-000000000131',
  '0000b132-0000-4000-8000-000000000132',
  '0000b133-0000-4000-8000-000000000133',
  '0000b134-0000-4000-8000-000000000134',
  '0000b135-0000-4000-8000-000000000135',
  '0000b136-0000-4000-8000-000000000136',
  '0000b137-0000-4000-8000-000000000137',
  '0000b138-0000-4000-8000-000000000138',
  '0000b139-0000-4000-8000-000000000139',
  '0000b140-0000-4000-8000-000000000140',
  '0000b141-0000-4000-8000-000000000141',
  '0000b142-0000-4000-8000-000000000142',
  '0000b143-0000-4000-8000-000000000143',
  '074fe527-507e-4d29-b865-a4622a05c7d3',
  '0e51b813-8e7f-4032-abaa-eb49bea56a84',
  'c70730c8-4d41-4aa9-acb1-1056d69f95ce',
  'c9b0ac28-2893-47a2-aa95-27b0d7e9c861',
  'cdca3000-0fc5-46c7-91cb-0509f98a778d',
  'd5ec77b9-09ce-40b1-8aa1-16e9dc740246'
 );
...
-- ── 7b. 게임화 (0014, spec §2b) ───────────────────────
-- 캐릭터는 curated 책 한 권에 한 마리. 검색으로 들어온 책(curated=false)에는 없다.
--
-- 이름은 **손으로** 붙였다 (강민구, 2026-09-18). 제목에서 기계로 만들면
-- 「아름답고 슬픈 야생 동물 이야기 요정」·「왜x100 요정」 같은 것이 도감 첫 화면에
-- 그대로 나온다. spec §2b 의 예시대로 그 책의 한 장면을 가리키는 이름으로 적었다
-- (「눈 어두운 포수」 → "안경 사슴").
--
-- stage_names 는 알 → 아기 X → 이름, 정확히 세 개다 (0014 의 check 제약).
-- art_seed 는 화면이 얼굴 이모지와 표지 색을 고르는 씨앗일 뿐이라 예전 값
-- (id 의 md5 앞 8자)을 그대로 둔다 — 같은 책이 늘 같은 얼굴로 나오면 된다
-- (verification/components/CollectionScreen.tsx).
insert into characters (book_id, name, stage_names, art_seed) values
  ('0000b001-0000-4000-8000-000000000001', '눈물 인력거', array['알', '아기 인력거', '눈물 인력거'], '350fc1cc'),  -- 운수 좋은 날
  ('0000b002-0000-4000-8000-000000000002', '달밤 나귀', array['알', '아기 나귀', '달밤 나귀'], '592b93bc'),  -- 메밀꽃 필 무렵
  ('0000b003-0000-4000-8000-000000000003', '봄봄 황소', array['알', '아기 황소', '봄봄 황소'], 'beff0d91'),  -- 봄봄
  ('0000b004-0000-4000-8000-000000000004', '동백 수탉', array['알', '아기 수탉', '동백 수탉'], '7f6014c4'),  -- 동백꽃
  ('0000b005-0000-4000-8000-000000000005', '감정용', array['알', '아기 용', '감정용'], '71cc175c'),  -- 아몬드
  ('0000b006-0000-4000-8000-000000000006', '복싱 여우', array['알', '아기 여우', '복싱 여우'], '8d5037d6'),  -- 완득이
  ('0000b007-0000-4000-8000-000000000007', '잎싹 암탉', array['알', '아기 암탉', '잎싹 암탉'], 'e3815122'),  -- 마당을 나온 암탉
  ('0000b008-0000-4000-8000-000000000008', '라임 오렌지새', array['알', '아기 오렌지새', '라임 오렌지새'], '0a516745'),  -- 나의 라임오렌지나무
  ('0000b009-0000-4000-8000-000000000009', '별밭 여우', array['알', '아기 여우', '별밭 여우'], '01515ba1'),  -- 어린 왕자
  ('0000b010-0000-4000-8000-000000000010', '농장 돼지', array['알', '아기 돼지', '농장 돼지'], 'f4b75ce9'),  -- 동물농장
  ('0000b012-0000-4000-8000-000000000012', '하늘 갈매기', array['알', '아기 갈매기', '하늘 갈매기'], '13d1109b'),  -- 갈매기의 꿈
  ('0000b013-0000-4000-8000-000000000013', '완장 늑대', array['알', '아기 늑대', '완장 늑대'], '0179f5c7'),  -- 우리들의 일그러진 영웅
  ('0000b015-0000-4000-8000-000000000015', '등짐 곰', array['알', '아기 곰', '등짐 곰'], '5b9199c9'),  -- 몽실 언니
  ('0000b016-0000-4000-8000-000000000016', '꼬부랑 지팡이', array['알', '아기 지팡이', '꼬부랑 지팡이'], '6870ea09'),  -- 꼬부랑할머니
  ('0000b017-0000-4000-8000-000000000017', '연못 금도끼', array['알', '아기 도끼', '연못 금도끼'], '810014f7'),  -- 금도끼
  ('0000b018-0000-4000-8000-000000000018', '형님 호랑이', array['알', '아기 호랑이', '형님 호랑이'], '58add605'),  -- 호랑이 형님
  ('0000b019-0000-4000-8000-000000000019', '꿈나비', array['알', '아기 나비', '꿈나비'], 'a4a266e3'),  -- 나비의 꿈
  ('0000b020-0000-4000-8000-000000000020', '여행 시골쥐', array['알', '아기 시골쥐', '여행 시골쥐'], '85487f76'),  -- 시골쥐 서울 구경
  ('0000b021-0000-4000-8000-000000000021', '셔츠 토끼', array['알', '아기 토끼', '셔츠 토끼'], '464cd634'),  -- 만년 셔츠
  ('0000b022-0000-4000-8000-000000000022', '동무 까치', array['알', '아기 까치', '동무 까치'], 'b3ba82f4'),  -- 동무를 위하여
  ('0000b023-0000-4000-8000-000000000023', '아기장수 매', array['알', '아기 매', '아기장수 매'], '855acc01'),  -- 두포전
  ('0000b024-0000-4000-8000-000000000024', '콩밭 두더지', array['알', '아기 두더지', '콩밭 두더지'], 'a7ce288a'),  -- 금 따는 콩밭
  ('0000b025-0000-4000-8000-000000000025', '러브레터 부엉이', array['알', '아기 부엉이', '러브레터 부엉이'], 'ae087b16'),  -- B사감과 러브레터
  ('0000b101-0000-4000-8000-000000000101', '겁쟁이 너구리', array['알', '아기 너구리', '겁쟁이 너구리'], '7c398440'),  -- 겁쟁이 도적
  ('0000b102-0000-4000-8000-000000000102', '옷 입은 까치', array['알', '아기 까치', '옷 입은 까치'], '33a03d95'),  -- 까치의 옷
  ('0000b103-0000-4000-8000-000000000103', '큰 두꺼비', array['알', '아기 두꺼비', '큰 두꺼비'], '0c65878f'),  -- 무서운 두꺼비
  ('0000b104-0000-4000-8000-000000000104', '샘물 개구리', array['알', '아기 개구리', '샘물 개구리'], '17367424'),  -- 이상한 샘물
  ('0000b105-0000-4000-8000-000000000105', '혼인 두더지', array['알', '아기 두더지', '혼인 두더지'], '65d0429e'),  -- 두더지의 혼인
  ('0000b106-0000-4000-8000-000000000106', '왕관 개구리', array['알', '아기 개구리', '왕관 개구리'], '1cca21e7'),  -- 개구리 왕자
  ('0000b107-0000-4000-8000-000000000107', '양초 도깨비', array['알', '아기 도깨비', '양초 도깨비'], '65bb8aea'),  -- 양초 귀신
  ('0000b108-0000-4000-8000-000000000108', '세쌍둥이 별', array['알', '아기 별', '세쌍둥이 별'], 'f0df624d'),  -- 삼태성
  ('0000b109-0000-4000-8000-000000000109', '안경 사슴', array['알', '아기 사슴', '안경 사슴'], '113d534b'),  -- 눈 어두운 포수
  ('0000b110-0000-4000-8000-000000000110', '잠자는 고양이', array['알', '아기 고양이', '잠자는 고양이'], '04931395'),  -- 잠자는 왕녀
  ('0000b111-0000-4000-8000-000000000111', '황금 거위', array['알', '아기 거위', '황금 거위'], '1609a18b'),  -- 황금 거위
  ('0000b113-0000-4000-8000-000000000113', '금빛 제비', array['알', '아기 제비', '금빛 제비'], '5633aee4'),  -- 왕자와 제비
  ('0000b114-0000-4000-8000-000000000114', '구명배 돌고래', array['알', '아기 돌고래', '구명배 돌고래'], 'b99ccbb1'),  -- 난파선
  ('0000b115-0000-4000-8000-000000000115', '땡볕 매미', array['알', '아기 매미', '땡볕 매미'], '1adf71c3'),  -- 땡볕
  ('0000b116-0000-4000-8000-000000000116', '기차 참새', array['알', '아기 참새', '기차 참새'], 'ff9c3979'),  -- 고향
  ('0000b117-0000-4000-8000-000000000117', '노래 도깨비', array['알', '아기 도깨비', '노래 도깨비'], '65cb62ef'),  -- 노래 주머니
  ('0000b118-0000-4000-8000-000000000118', '병 속 마귀', array['알', '아기 마귀', '병 속 마귀'], 'f523e4eb'),  -- 어부와 마귀
  ('0000b119-0000-4000-8000-000000000119', '삼남매 오리', array['알', '아기 오리', '삼남매 오리'], '7d4d2cb0'),  -- 흘러간 삼남매
  ('0000b120-0000-4000-8000-000000000120', '털보 곰', array['알', '아기 곰', '털보 곰'], 'b4bda3cf'),  -- 털보 장사
  ('0000b121-0000-4000-8000-000000000121', '따라지 고양이', array['알', '아기 고양이', '따라지 고양이'], '44192c30'),  -- 봄과 따라지
  ('0000b122-0000-4000-8000-000000000122', '등불 나방', array['알', '아기 나방', '등불 나방'], '9df1fa11'),  -- 빈처
  ('0000b123-0000-4000-8000-000000000123', '만무방 들쥐', array['알', '아기 들쥐', '만무방 들쥐'], '845e164d'),  -- 만무방
  ('0000b124-0000-4000-8000-000000000124', '옹기 거북', array['알', '아기 거북', '옹기 거북'], '959beb30'),  -- 옹기 셈
  ('0000b125-0000-4000-8000-000000000125', '눈물 종달새', array['알', '아기 종달새', '눈물 종달새'], '1b926af5'),  -- 눈물의 노래
  ('0000b126-0000-4000-8000-000000000126', '벚꽃 나비', array['알', '아기 나비', '벚꽃 나비'], '78d90628'),  -- 벚꽃 이야기
  ('0000b127-0000-4000-8000-000000000127', '선물 다람쥐', array['알', '아기 다람쥐', '선물 다람쥐'], 'a2ed8c9d'),  -- 선물 아닌 선물
  ('0000b128-0000-4000-8000-000000000128', '작은 천사', array['알', '아기 천사', '작은 천사'], '5ada6796'),  -- 천사
  ('0000b129-0000-4000-8000-000000000129', '붉은 산 삵', array['알', '아기 삵', '붉은 산 삵'], '0535293e'),  -- 붉은 산
  ('0000b130-0000-4000-8000-000000000130', '으스대는 공작', array['알', '아기 공작', '으스대는 공작'], '8aa3aa30'),  -- 미스터 방
  ('0000b131-0000-4000-8000-000000000131', '고집쟁이 당나귀', array['알', '아기 당나귀', '고집쟁이 당나귀'], '4204ab9a'),  -- 치숙
  ('0000b132-0000-4000-8000-000000000132', '엉뚱이 하마', array['알', '아기 하마', '엉뚱이 하마'], '7e356f01'),  -- 미련이 나라
  ('0000b133-0000-4000-8000-000000000133', '바이올린 귀뚜라미', array['알', '아기 귀뚜라미', '바이올린 귀뚜라미'], '1b9a3efa'),  -- 어린 음악가
  ('0000b134-0000-4000-8000-000000000134', '탐정 강아지', array['알', '아기 강아지', '탐정 강아지'], '7f22adda'),  -- 동생을 찾으러
  ('0000b135-0000-4000-8000-000000000135', '꽃다발 참새', array['알', '아기 참새', '꽃다발 참새'], 'e67d2ed4'),  -- 참된 동정
  ('0000b136-0000-4000-8000-000000000136', '엉터리 펭귄', array['알', '아기 펭귄', '엉터리 펭귄'], '59778c8a'),  -- 엉터리 병정
  ('0000b137-0000-4000-8000-000000000137', '수수께끼 까마귀', array['알', '아기 까마귀', '수수께끼 까마귀'], '6cc8af29'),  -- 과거 문제
  ('0000b138-0000-4000-8000-000000000138', '그리움 오리', array['알', '아기 오리', '그리움 오리'], '1a7fa616'),  -- 영길이의 설움
  ('0000b139-0000-4000-8000-000000000139', '뿌움뿌움 광대', array['알', '아기 광대', '뿌움뿌움 광대'], 'ad494052'),  -- 뿌움뿌움 이야기
  ('0000b140-0000-4000-8000-000000000140', '등대 물개', array['알', '아기 물개', '등대 물개'], 'cdacdf6d'),  -- 절영도 섬 너머
  ('0000b141-0000-4000-8000-000000000141', '방귀 덜렁이', array['알', '아기 덜렁이', '방귀 덜렁이'], '823328b1'),  -- 방귀 출신 최덜렁
  ('0000b142-0000-4000-8000-000000000142', '막보 장사꾼', array['알', '아기 장사꾼', '막보 장사꾼'], 'd9a8f047'),  -- 막보의 큰 장사
  ('0000b143-0000-4000-8000-000000000143', '금시계 토끼', array['알', '아기 토끼', '금시계 토끼'], '3d74b841'),  -- 금시계
  ('074fe527-507e-4d29-b865-a4622a05c7d3', '야생 늑대', array['알', '아기 늑대', '야생 늑대'], '6e41e536'),  -- 아름답고 슬픈 야생 동물 이야기
  ('0e51b813-8e7f-4032-abaa-eb49bea56a84', '물음표 병아리', array['알', '아기 병아리', '물음표 병아리'], 'db87992e'),  -- 왜x100
  ('c70730c8-4d41-4aa9-acb1-1056d69f95ce', '파란만장 고래', array['알', '아기 고래', '파란만장 고래'], 'd6b68fae'),  -- 파란만장 내 인생
  ('c9b0ac28-2893-47a2-aa95-27b0d7e9c861', '토요일 코끼리', array['알', '아기 코끼리', '토요일 코끼리'], '2f4104ab'),  -- 아빠와 토요일
  ('cdca3000-0fc5-46c7-91cb-0509f98a778d', '구두 고양이', array['알', '아기 고양이', '구두 고양이'], 'd94dcf84'),  -- 구두 전쟁
  ('d5ec77b9-09ce-40b1-8aa1-16e9dc740246', '갈림길 올빼미', array['알', '아기 올빼미', '갈림길 올빼미'], 'a2a92a8f')  -- 제후의 선택
on conflict (book_id) do update
  set name        = excluded.name,
      stage_names = excluded.stage_names,
      art_seed    = excluded.art_seed;

-- 나중에 curated 책이 늘어도 캐릭터 없는 책이 생기지 않게 하는 그물.
-- 위 목록에 있는 책은 이미 들어갔으므로 여기서 걸리지 않는다 — 새 책이 걸렸다면
-- 임시 이름이 붙은 것이니 위 목록에 손으로 옮겨 적어야 한다.
insert into characters (book_id, name, stage_names, art_seed)
select b.id,
       b.title || ' 친구',
       array['알', '아기 친구', b.title || ' 친구'],
       substr(md5(b.id::text), 1, 8)
  from books b
 where b.curated
   and not exists (select 1 from characters c where c.book_id = b.id)
