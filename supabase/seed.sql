...
insert into books (id, isbn13, title, author, publisher, tags,
  ...
  ('0000b006-0000-4000-8000-000000000006', '9788936456085', '완득이',        '김려령',   '창비',       '{"성장","한국소설"}',       6, 9, false, null, null),
  ('0000b007-0000-4000-8000-000000000007', '9791160946635', '마당을 나온 암탉', '황선미', '사계절',     '{"동화","성장"}',           3, 6, false, null, null),
  ('0000b008-0000-4000-8000-000000000008', '9791128218705', '나의 라임오렌지나무', '조제 마우루', '아람', '{"성장","외국소설"}',     5, 8, false, null, null),
  ('0000b009-0000-4000-8000-000000000009', '9788915100275', '어린 왕자',      '생텍쥐페리', '삼성출판사', '{"고전","외국소설","철학"}', 4, 9, false, null, null),
  ('0000b010-0000-4000-8000-000000000010', '9788900282931', '동물농장',       '조지 오웰',  '두산동아',   '{"고전","외국소설","사회"}', 7, 9, false, null, null),
  ('0000b011-0000-4000-8000-000000000011', null, 'harry',         '데모 저자',  '데모출판',  '{"판타지","외국소설"}',     4, 8, false, null, null),
  ('0000b012-0000-4000-8000-000000000012', '9788997173587', '갈매기의 꿈',    '리처드 바크', '와니북스', '{"성장","외국소설"}',     5, 9, false, null, null),
  ('0000b013-0000-4000-8000-000000000013', '9788987721095', '우리들의 일그러진 영웅', '이문열', '다림', '{"한국소설","사회"}',      7, 9, false, null, null),
  ('0000b014-0000-4000-8000-000000000014', null, 'squirrel',      '데모 저자',  '데모출판',  '{"과학","교양"}',           5, 8, false, null, null),
  ('0000b015-0000-4000-8000-000000000015', '9788936477721', '몽실 언니',      '권정생',    '창비',      '{"역사","한국소설"}',       5, 8, false, null, null)
