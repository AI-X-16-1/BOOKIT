    ...
    <>
      ...
      <Table
        ...
        rows={[
          ...
          [
            "이용 중 생성",
            "독후감 본문, AI 질문·답변, 채점 결과, 책갈피 적립 내역, 연속 기록, 읽은 책 목록",
            "서비스 이용",
          ],
        ]}
      />
      ...
      <Table
        ...
        rows={[
          [
            "Anthropic, PBC",
            "미국",
            "독후감 본문, 학생 답변, 책 제목·저자·줄거리, 학년",
            "AI 빈틈 분석·질문 생성·채점",
            "학생이 독후감을 제출·답변할 때 API 전송",
            "수신 후 30일 이내 자동 삭제. 이용 정책 위반으로 자동 분류되면 최대 2년",
          ],
          [
            "Supabase, Inc.",
