...
export const BOOKS: DemoBook[] = [
  ...
  { id: "b6", isbn13: "9788936456085", title: "완득이", author: "김려령", publisher: "창비", cover_url: null, tags: ["성장", "한국소설"], target_grade_min: 6, target_grade_max: 9, is_public_domain: false, library_url: null, aladin_url: null, curated: true, cover: "coral" },
  { id: "b7", isbn13: "9791160946635", title: "마당을 나온 암탉", author: "황선미", publisher: "사계절", cover_url: null, tags: ["동화", "성장"], target_grade_min: 3, target_grade_max: 6, is_public_domain: false, library_url: null, aladin_url: null, curated: true, cover: "yellow" },
  { id: "b9", isbn13: "9788915100275", title: "어린 왕자", author: "생텍쥐페리", publisher: "문학동네", cover_url: null, tags: ["고전", "철학"], target_grade_min: 4, target_grade_max: 9, is_public_domain: false, library_url: null, aladin_url: null, curated: true, cover: "blue" },
  { id: "b15", isbn13: "9788936477721", title: "몽실 언니", author: "권정생", publisher: "창비", cover_url: null, tags: ["역사", "한국소설"], target_grade_min: 5, target_grade_max: 8, is_public_domain: false, library_url: null, aladin_url: null, curated: true, cover: "coral" },
];
